...
export const APP_EXT_PROP_EMIT_BUTTON_ID = "chrome-ext-ng-properties-emit-btn";
...
export const APP_EXT_PROP_VIEW_ID = "chrome-ext-ng-properties-view";
export const APP_EXT_PROP_OUTPUT_JSON_ID =
  "chrome-ext-ng-properties-prop-is-json";
export const APP_EXT_PROP_OUTPUT_VALUE = APP_EXT_CONST + "-output-value";
...
export const APP_EXT_PROP_OBJECT_VALUE_ERROR = APP_EXT_CONST + "-object-error";
export const APP_EXT_TOGGLE_BTN_ID = APP_EXT_CONST + "-toggle-btn";
export const APP_EXT_PROP_TYPE_RADIO_NAME = APP_EXT_CONST + "-prop-type-radio";
export const APP_EXT_INPUT_SELECT_ID = APP_EXT_CONST + "-input-select";
export const APP_EXT_OUTPUT_SELECT_ID = APP_EXT_CONST + "-output-select";
...
export function TOOLTIP_HTML(): string {
  ...
  <div class="position-absolute" style="top: 0px; right: 0px; z-index: 1">
    <button
      ...
      class="btn btn-sm"
      aria-label="Close"
      id="chrome-ext-ng-properties-close-btn"
  ...
  <div class="container-fluid p-3 pb-4 position-relative">
    ...
    <div class="container-fluid px-0">
      ...
      <div class="row">
        <div class="col-12">
          <div id="${APP_EXT_PROP_VIEW_ID}"></div>
        </div>
      </div>
    </div>
  </div>
